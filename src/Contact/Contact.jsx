    ...
    <div className="container px-6 py-12 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
            <div className="flex flex-col items-center justify-center text-center">
                ...
                <Link className="mt-2 text-blue-500 dark:text-blue-400 " >rajkolekar38@gmail.com</Link>
                <button className="bg-sky-500 p-2 rounded-lg m-1 hover:text-white hover:bg-sky-400" >copy</button>
            </div>
            ...
            <div className="flex flex-col items-center justify-center text-center">
                ...
                <p className="mt-2 text-blue-500 dark:text-blue-400">12, Warvatkar Sankul, Koshti Ali khed, Ratnagiri-415709</p>
            </div>
            ...
            <div className="flex flex-col items-center justify-center text-center">
                ...
                <p className="mt-2 text-blue-500 dark:text-blue-400">+91 7666513674</p>
